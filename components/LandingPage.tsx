...
const Polaroid: React.FC<{ 
  ...
  <div className={`relative group w-full aspect-[4/5] max-w-[160px] md:max-w-[190px] rounded-lg p-2 pb-6 bg-white shadow-xl border border-rose-50 transition-all duration-500 hover:rotate-0 hover:scale-105 hover:z-20 ${rotation}`}>
    <div className="w-full h-full rounded-sm overflow-hidden bg-rose-50 relative flex items-center justify-center border border-rose-100/30">
      {image ? (
        ...
        <div className="text-rose-200 flex flex-col items-center">
          ...
          <p className="font-satisfy text-[8px] mt-1 uppercase tracking-widest">{label}</p>
        </div>
      )}
    ...
    <div className="absolute bottom-1 left-0 w-full text-center">
      <span className="font-satisfy text-rose-400 text-xs md:text-sm">{label}</span>
    </div>
    <div className="absolute -top-1 left-1/2 -translate-x-1/2 w-6 h-3 bg-white/40 backdrop-blur-sm border border-white/20 rounded-sm rotate-3 shadow-sm" />
        ...
        {!isOpen ? (
          <div className="relative w-full h-full bg-rose-100 rounded-lg shadow-2xl flex items-center justify-center group overflow-hidden border border-rose-200">
            ...
            <button
              ...
              className="z-10 bg-white text-rose-500 px-10 py-3 rounded-full font-bold shadow-lg hover:shadow-rose-200 hover:scale-105 transition-all duration-300 border border-rose-100 font-montserrat tracking-widest uppercase text-sm glow-button"
            >
              Open Letter
            </button>
          ...
          <div className="w-full bg-[#fffcf9] rounded-2xl shadow-[0_25px_60px_rgba(255,182,193,0.4)] p-6 md:p-12 border border-rose-100 animate-in fade-in zoom-in duration-700">
            <div className="grid grid-cols-1 lg:grid-cols-[1fr_400px] gap-8 items-center">
              <div className="space-y-6 text-slate-700">
                ...
                <div className="font-handwritten text-xl md:text-2xl leading-relaxed space-y-4 opacity-90">
                  <p>Hey Babe,</p>
              ...
              <div className="relative flex flex-col items-center">
                ...
                <div className="grid grid-cols-2 gap-4 w-full">
                  <div className="col-span-2 flex justify-center">
                    <Polaroid image={images[0]} onUpload={handleImageUpload(0)} label="Ours Forever" rotation="-rotate-2" />
                  </div>
                ...
                <p className="mt-8 font-satisfy text-rose-400 text-sm italic animate-pulse">Our special memories...</p>
              </div>
            </div>
